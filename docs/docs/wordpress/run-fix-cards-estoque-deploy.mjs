...
const deployCode = fs.readFileSync(path.join(dir, '.deploy-fix-cards-estoque-once.js'), 'utf8');
...
fs.writeFileSync(path.join(dir, 'fix-cards-estoque-result.json'), JSON.stringify(result, null, 2));
