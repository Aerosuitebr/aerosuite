#!/usr/bin/env node
/**
 * Gera Confronto Técnico — Homologação UX Relatório 3 / Onboarding (PDF + HTML).
 * Uso: node scripts/build-homolog-confronto-relatorio3-pdf.mjs
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
import { META, SECTIONS, ITEMS, SCORE, STATUS } from '../docs/homolog_ux/confronto-relatorio3-data.mjs';
...
const htmlOut = path.join(docDir, `Confronto_Homolog_UX_Relatorio3_${stamp}.html`);
const pdfOut = path.join(docDir, `Confronto_Homolog_UX_Relatorio3_${stamp}_verificado.pdf`);
...
<section class="page">
  ...
  <div class="page-footer">
    <span>Aero Suite · Confronto UX Relatório 3</span>
...
<section class="cover">
  ...
  <div class="cover-inner">
    ...
    <div class="cover-badge">Confronto técnico · Relatório 3 · Onboarding · Confidencial</div>
...
<section class="page">
  ...
  <p class="lead">
    Confronto entre o <strong>Relatório 3 — Onboarding</strong> (14 findings F01–F14, 16/jun/2026) e o estado atual em
    <strong>${esc(META.site)}</strong>, com reteste automatizado em ${esc(META.date)}.
  </p>

  <div class="score-grid">
    <div class="score-card"><div class="score-val">${SCORE.total}</div><div class="score-label">Findings (F01–F14)</div></div>
  ...
  <table class="metric-table">
    ...
    <tbody>
      ...
      <tr><td>Crítico F04 (multi-tenant assets)</td><td><strong>${SCORE.pctCriticosResolvidos}%</strong> resolvido no código</td></tr>
    </tbody>
  </table>
