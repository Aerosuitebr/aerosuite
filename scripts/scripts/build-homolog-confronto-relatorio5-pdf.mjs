#!/usr/bin/env node
/**
 * Gera Confronto Técnico — Homologação UX Relatório 5 (PDF + HTML).
 * Uso: node scripts/build-homolog-confronto-relatorio5-pdf.mjs
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
import { META, SECTIONS, ITEMS, SCORE } from '../docs/homolog_ux/confronto-relatorio5-data.mjs';
...
const htmlOut = path.join(docDir, `Confronto_Homolog_UX_Relatorio5_${stamp}.html`);
const pdfOut = path.join(docDir, `Confronto_Homolog_UX_Relatorio5_${stamp}_verificado.pdf`);
...
<section class="page">
  ...
  <div class="page-footer">
    <span>Aero Suite · Confronto UX Relatório 5</span>
...
<section class="cover">
  ...
  <div class="cover-inner">
    ...
    <div class="cover-badge">Confronto técnico · Relatório 5 · Confidencial</div>
...
<section class="page">
  ...
  <p class="lead">
  O Relatório 5 (Sessão 3, 18/jun/2026) catalogou <strong>13 achados novos</strong> (R-02 a R-14) em Relatórios, Dashboard e Conformidade Técnica,
  incluindo <strong>${META.criticosRelatorio} críticos</strong> e <strong>${META.altosRelatorio} altos</strong>.
  Este documento confronta cada achado com o estado após correção, deploy e verificação em produção.
  </p>
  ...
  <table class="metric-table">
    ...
    <tbody>
      <tr><td>Verificações automatizadas / manuais</td><td><strong>${SCORE.verificacaoAutomaticaPass}/${SCORE.verificacaoAutomaticaTotal}</strong></td></tr>
      <tr><td>Conformidade global</td><td><strong>${SCORE.pctConformidadeAchados}%</strong> (${SCORE.verified}/${SCORE.total})</td></tr>
      <tr><td>Críticos (R-10, R-13)</td><td><strong>${SCORE.pctCriticosResolvidos}%</strong></td></tr>
      <tr><td>Altos (R-06, R-08)</td><td><strong>${SCORE.pctAltosResolvidos}%</strong></td></tr>
    </tbody>
  </table>
