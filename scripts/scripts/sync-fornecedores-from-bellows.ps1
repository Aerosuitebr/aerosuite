# Copia fornecedor: bellows -> aerosuite (UTF-8, preserva IDs e FKs).
# Uso: .\scripts\sync-fornecedores-from-bellows.ps1

$ErrorActionPreference = 'Stop'
$repoRoot = Split-Path -Parent $PSScriptRoot
$sqlFile = Join-Path $repoRoot 'db\scripts\sync_fornecedor_bellows_to_aerosuite.sql'
...
Write-Host "Sincronizando fornecedor: bellows -> aerosuite em ${dbHost}:${port} ..."
...
Write-Host 'Concluido. Atualize a lista de Fornecedores no browser (Ctrl+F5).'
