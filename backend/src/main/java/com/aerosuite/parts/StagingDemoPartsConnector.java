...
public class StagingDemoPartsConnector implements PartsFinderConnector {
    ...
    public List<PartsFinderResult> search(PartsFinderSearchRequest request) {
        ...
        return List.of(
                offer(pn, "FCU / componente aeronáutico", "OH", "8", "12450.00", "Demo Aviation USA", "US", "FAA 8130-3", "Miami, FL", "APROVADO", true, 4),
                offer(pn, "Componente aeronáutico intercambiável", "SV", "3", "10980.00", "Demo Global Rotables", "GB", "EASA Form 1", "London, UK", "PENDENTE", false, 72),
                offer(pn, "Peça aeronáutica rastreável", "NEW", "12", "15600.00", "Demo Aero Supply", "BR", "FAA 8130-3 / NFe", "São Paulo, BR", "APROVADO", true, 2),
                offer(pn, "Unidade revisada com documentação", "OH", "2", null, "Demo MRO Exchange", "CA", "TCCA Form One", "Toronto, CA", "PENDENTE", false, 48)
        ).stream()
    ...
    private PartsFinderResult offer(String pn, String description, String condition, String quantity,
                                    ...
                                    String location, String asl, boolean aogAvailable, int leadTimeHours) {
        ...
        r.aogAvailable = aogAvailable; r.estimatedLeadTimeHours = leadTimeHours;
